...
PYBIND11_MODULE(_frankx, m) {
  ...
  waypoint.def(py::init<>())
      ...
      .def(py::init<const Affine&, ReferenceType, double>(), "affine"_a, "reference_type"_a = ReferenceType::Absolute,
           "dynamic_rel"_a = 1.0)
      .def(py::init<const Affine&, double, ReferenceType, double>(), "affine"_a, "elbow"_a,
           "reference_type"_a = ReferenceType::Absolute, "dynamic_rel"_a = 1.0)
  ...
  py::class_<ImpedanceMotion>(m, "ImpedanceMotion")
      ...
      .def("set_linear_relative_target_motion", &ImpedanceMotion::setLinearRelativeTargetMotion, "relative_target"_a,
           "duration"_a)
      .def("set_spiral_target_motion", &ImpedanceMotion::setSpiralTargetMotion)
      .def("add_force_constraint",
           (void(ImpedanceMotion::*)(std::optional<double>, std::optional<double>, std::optional<double>)) &
               ImpedanceMotion::addForceConstraint,
           py::kw_only(), "x"_a = std::nullopt, "y"_a = std::nullopt, "z"_a = std::nullopt)
  ...
  py::class_<Robot>(m, "Robot")
      .def(py::init<const std::string&, double, bool, bool>(), "fci_ip"_a, "dynamic_rel"_a = 1.0, "repeat_on_error"_a = true,
           "stop_at_python_signal"_a = true)
      ...
      .def("move", (bool(Robot::*)(const Affine&, ImpedanceMotion&, MotionData&)) & Robot::move,
      ...
      .def("move", (bool(Robot::*)(const Affine&, PathMotion, MotionData&)) & Robot::move,
           py::call_guard<py::gil_scoped_release>())
      ...
      .def("move", (bool(Robot::*)(const Affine&, WaypointMotion&, MotionData&)) & Robot::move,
           py::call_guard<py::gil_scoped_release>(), "frame"_a, "waypoint_motion"_a, "motion_data"_a);

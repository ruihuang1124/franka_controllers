...
namespace movex {
  ...
  struct ImpedanceMotion {
    ...
    double exponential_decay {0.005};  // original value: 0.005
  ...
  public:
    ...
    explicit ImpedanceMotion(double translational_stiffness, double rotational_stiffness)
        : translational_stiffness(translational_stiffness), rotational_stiffness(rotational_stiffness), type(Type::Cartesian) { }
    ...
    void addForceConstraint(std::optional<double> x = std::nullopt, std::optional<double> y = std::nullopt,

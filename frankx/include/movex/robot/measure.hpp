...
class Condition {
 ...
 public:
  ...
  bool operator()(const RobotState_& robot_state, double time) { return callback(robot_state, time); }
...
class Measure {
 ...
 public:
  static Measure ForceX() {
    return Measure([](const RobotState_& robot_state, double time) { return robot_state.O_F_ext_hat_K[0]; });
  }

  static Measure ForceY() {
    return Measure([](const RobotState_& robot_state, double time) { return robot_state.O_F_ext_hat_K[1]; });
  }

  static Measure ForceZ() {
    return Measure([](const RobotState_& robot_state, double time) { return robot_state.O_F_ext_hat_K[2]; });
  }
  ...
  static Measure Time() {
    return Measure([](const RobotState_& robot_state, double time) { return time; });
  }

  Condition operator==(double threshold) {
    return Condition(
        [*this, threshold](const RobotState_& robot_state, double time) { return callback(robot_state, time) == threshold; });
  }

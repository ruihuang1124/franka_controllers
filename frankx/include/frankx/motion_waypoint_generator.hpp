...
struct WaypointMotionGenerator : public MotionGenerator {
  ...
  void init(const franka::RobotState& robot_state, franka::Duration period) {
    ...
    Vector7d initial_velocity =
        (Vector7d() << robot_state.O_dP_EE_c[0], robot_state.O_dP_EE_c[1], robot_state.O_dP_EE_c[2], robot_state.O_dP_EE_c[3],
         robot_state.O_dP_EE_c[4], robot_state.O_dP_EE_c[5], robot_state.delbow_c[0])
            .finished();
